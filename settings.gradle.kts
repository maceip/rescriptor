...
include(":os:server:ktor:api")
include(":os:server:ktor:real")
...
include(":os:server:postgresqloperator:api")
include(":os:server:postgresqloperator:exec")
include(":os:server:postgresqloperator:external")
include(":os:server:usernames:real")
include(":os:server:testing")
include(":os:server:vault")
include(":os:server:wallpapers")
include(":os:server:wasm:api")
include(":os:server:wasm:endive")
include(":os:server:wasm:jvm")
include(":os:server:website:api")
include(":os:server:website:real")
include(":os:server:wiring")
include(":platform:api")
include(":platform:mediation")
